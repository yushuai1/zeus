...
public class 开挂4 {
    ...
    private  int[] 计算(List<byte[]> 生成数据, byte[] 被比较数据) {
        ...
        for (int s = 0; s < 512; s = s + 2) {
            ...
            if (被比较数据[s/2] == 2) {
                ...
                if (生成数据.get(10)[s + 1] == 1) {
                    countArray[10]++;
                }
                if (生成数据.get(11)[s + 1] == 1) {
                    countArray[11]++;
                }
                if (生成数据.get(12)[s + 1] == 1) {
                    countArray[12]++;
                }
                if (生成数据.get(13)[s + 1] == 1) {
                    countArray[13]++;
                }
                if (生成数据.get(14)[s + 1] == 1) {
                    countArray[14]++;
                }
                if (生成数据.get(15)[s + 1] == 1) {
                    countArray[15]++;
                }
                if (生成数据.get(16)[s + 1] == 1) {
                    countArray[16]++;
                }
                if (生成数据.get(17)[s + 1] == 1) {
                    countArray[17]++;
                }
                if (生成数据.get(18)[s + 1] == 1) {
                    countArray[18]++;
                }
                if (生成数据.get(0)[s] == 1) {
                    countArray[0]++;
