public class TestC {
    ...
    static private final float choutu = 50000;
    /**
     * max=单机最大并发，50万底库
     */
    static private final float max = 120;
    /**
     * 3台机器
     */
...
//        float once=number/pcCount;
        ...
        System.out.println("并发量："+number+" cpu使用率："+cpu+" 相应时间："+backTime+"  tps:"+sumTps*0.9);


    }
    public static void main(String[] args) {

        runc(50.0f,0.7f,1.6f);
    }
}
